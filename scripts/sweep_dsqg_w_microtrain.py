...
def _compact_run(run_id: str, report: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "train_mean_rank_initial": float(report["train_mean_rank_initial"]),
        "train_mean_rank_final": float(report["train_mean_rank_final"]),
        "train_mean_rank_delta": float(report["train_mean_rank_delta"]),
        "train_top1_acc_initial": float(report["train_top1_acc_initial"]),
        "train_top1_acc_final": float(report["train_top1_acc_final"]),
        "train_top1_acc_delta": float(report["train_top1_acc_delta"]),
        "train_top5_acc_initial": float(report["train_top5_acc_initial"]),
        "train_top5_acc_final": float(report["train_top5_acc_final"]),
        "train_top5_acc_delta": float(report["train_top5_acc_delta"]),
