...
```text
/home/dlewis3/Desktop/AI/DWARF-v2
```
...
The DSQG-W true-backward/scheduling work has been merged into main. It adds V20-style scheduling and opt-in split backward organization while keeping fused true-backward default.
